...
return global;})(this);
opCreativeSetCookieA("op1799openboxgum", "a00500d00h2c5ok02s15v12c5pj07w3vp339a", opCreativeGetDocumentSLD(), 604800);
if( "" ){ opCreativeSetCookieA("op1799openboxliid", "a00500d00h2c5ok02s15v12c5pj07w3vp339a", opCreativeGetDocumentSLD(), 86400);}
...
optg.variables[objName] = {
debug: true,
creative: 'cr #17 - wv #' + objName + ' - "All Visitors" persona - ',
...
'',
''].join('');
optg.functions[currentWave].areaC_2 = function(timeout) {
...
optg.functions[currentWave].logStatus('areaC_2', false);
setTimeout(function() {
optg.functions[currentWave].areaC_2(timeout);
}, 200);
return;
}

jQuery('.nextButton a').html('Select Open Box');

optg.functions[currentWave].logStatus('areaC_2', true);
if (timeout > 0) {
optg.functions[currentWave].displayContent();
}
};
optg.functions[currentWave].areaC_2(0);
